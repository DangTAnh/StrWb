...
- [x] 06-02-PLAN.md — Cart (session) + add/update/remove + total
- [x] 06-03-PLAN.md — Checkout form + submit route + CSRF/honeypot + success
...
- [x] 08-01-PLAN.md — Revenue + profit stats
...
- [x] 08-03-PLAN.md — Inventory counts dashboard
...
- [x] 09-02-PLAN.md — v1.1 verification harness (16 reqs + v1.0 smoke + V-01/V-02)
