...
class ProductForm(FlaskForm):
    ...
    price = IntegerField('Giá (VND)', validators=[DataRequired(message='Vui lòng nhập giá'), NumberRange(min=0, message='Giá không được âm')])
    ...
    quantity = IntegerField('Tồn kho', validators=[DataRequired(message='Vui lòng nhập tồn kho'), NumberRange(min=0, message='Tồn kho không được âm')], default=0)
